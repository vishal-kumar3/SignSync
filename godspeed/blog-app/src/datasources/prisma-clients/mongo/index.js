...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/datasources/prisma-clients/mongo",
    "datasources/prisma-clients/mongo",
  ]
...
path.join(process.cwd(), "src/datasources/prisma-clients/mongo/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/datasources/prisma-clients/mongo/schema.prisma")
